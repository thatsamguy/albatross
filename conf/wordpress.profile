# nginx template
# wordpress template with dynamic redirects
...
# _directory_ = local directory of wordpress installation
...
_redirect__custom_
    if (!-e $request_filename) {
        rewrite ^/wp-(.+)$ _directory_wp-$1 last;
        rewrite ^/(.+)$ _directory_index.php last;
    }
