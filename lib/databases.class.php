...
class database
{
    ...
    public function add($name, $acc_id, $passwd)
    { // adds a new database for a user based upon the name provided
    global $error;
    // escape name
    ...
    public function archive($database)
    {
        return false;
    }

    public function update_passwd($name, $acc_id, $passwd)
    { // updates the access password for the user account for all databases
    global $error;
    // escape name
    $esc = $this->db->esc($name);
        unset($name);
    ...
    { // grabs the current status of all databases for an acc_id
    global $error;
    ...
    private function database_size($database)
    { // returns number of tables, and total size of table rows and indicies
    global $error;
    ...
    public function db_status($database)
    { // grabs the current status of each table for a database
    global $error;
