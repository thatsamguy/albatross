...
<div class="block midwidth">
  <h3>DNS servers<?php if($domain_id>0){ echo " for ".$domain;}?></h3>
  <table>
    <?php
...
<div class="block midwidth">
  <h3>Update DNS servers<?php if($domain_id>0){ echo " for ".$domain;}?></h3>
  <!--<form action="/dns/server/<?php echo $domain_id;?>" method="post">
  <table>
    <thead>
      <tr>
