...
<div class="block doublewidth">
  <h3>Add new dns record<?php if($domain_id>0){ echo " for ".$domain;}?></h3>
  ...
  <table>
	...
	<th colspan="3" class="center"><input type="submit" name="add" value="Add record"></th>
      ...
      <tr>
	<td><a href="/dns/server/<?php echo $domain_id;?>">Add NS record</a></td>
	<td colspan="2"><a href="/dns/email/<?php echo $domain_id;?>">Add MX record</a></td>
      </tr>
      <?php } ?>
    </tbody>
  </table>
...
?>
<div class="block doublewidth">
  <h3>Edit record<?php if($domain_id>0){ echo " for ".$domain;}?></h3>
